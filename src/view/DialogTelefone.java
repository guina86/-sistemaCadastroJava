...
public class DialogTelefone extends javax.swing.JDialog {
    ...
    private void preencherCampos(Telefone telefone) {
        campoId.setText(telefone.getId().toString());
    ...
    private void preencherTabela() {
        ...
        tabelaTelefone.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(campoNumero, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void botaoSalvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvaActionPerformed
        if (modoEdicao.equals("salvar")) {
            ...
            Telefone telefone = new Telefone(Integer.valueOf(campoId.getText()), campoNumero.getText());
            telefoneDao.update(telefone);
            modeloTabela.setValueAt(telefone, current);
        }
        setInterface(false, true, false, false, false, true, false, true, true);
    ...
    private void tabelaTelefoneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaTelefoneMouseClicked
        current = tabelaTelefone.getSelectedRow();
        Telefone telefone = modeloTabela.get(current);
        preencherCampos(telefone);
        setInterface(false, true, false, true, true, true, false, true, false);
    ...
    private void botaoPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPrimeiroActionPerformed
        ...
        Telefone telefone = modeloTabela.get(0);
        preencherCampos(telefone);
        setInterface(false, true, false, true, true, true, false, true, false);
